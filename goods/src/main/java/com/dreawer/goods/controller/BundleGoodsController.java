...
/**
 * <CODE>BundleGoodsController</CODE>
 * 绑定商品（不单独销售）信息控制器
 * @author kael
 */
@Controller
@RequestMapping(value = REQ_BUNDLE_GOODS)
public class BundleGoodsController extends BaseController{
    ...
    public @ResponseBody ResponseCode add(HttpServletRequest req, @RequestBody @Valid AddGoodsForm form, BindingResult result) {
    	...
    	try {
    		...
    		goods.setType(GoodsType.BUNDLED);
    ...
    public @ResponseBody ResponseCode list(HttpServletRequest req, @RequestBody @Valid QueryGoodsesForm form, BindingResult result) {
    	...
    	try {
    		...
    		//执行查询
    		ResponseCode responseCode = goodsService.findGoodses(form.getStoreId(), form.getGroupId(), GoodsType.BUNDLED, form.getStatus(), form.getIsRecommend(), form.getCategoryId(), form.getKeyword(), form.getStart(), form.getPageSize());
    ...
    public @ResponseBody ResponseCode sellingList(HttpServletRequest req, @RequestBody @Valid QuerySellingGoodsesForm form, BindingResult result) {
    	...
    	try {
    		...
    		//执行查询
    		ResponseCode responseCode = goodsService.findSellingGoodses(form.getStoreId(), form.getGroupId(), GoodsType.BUNDLED, form.getIsRecommend(), form.getCategoryId(), form.getKeyword(), form.getStart(), form.getPageSize());
    ...
    public @ResponseBody ResponseCode detail(HttpServletRequest req, @RequestParam(ID)String id) {
    	try {
    		...
    		//执行查询
    		ResponseCode responseCode = goodsService.findGoodsDetail(id, GoodsType.BUNDLED);
